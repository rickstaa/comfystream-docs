...
<Steps>
  <Step title="Select your workflow">
    Click on **Choose files** and select one of the previously downloaded workflows from the [Comfystream repository](https://github.com/livepeer/comfystream/tree/main/workflows/comfystream).
  </Step>
...
<Tip>
Copy the [example-workflow.json](https://github.com/livepeer/comfystream/raw/main/workflows/comfystream/sd15-multi-cnet-depthanything-face-api.json) to local storage and lunch it from comfystreamUI as shown above: 
