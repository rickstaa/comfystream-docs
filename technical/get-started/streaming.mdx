...
After setting up ComfyStream and running your first workflow, you can use OBS Studio to capture and broadcast your AI-enhanced streams to your favorite platforms — whether it’s YouTube, Twitch, or distributed infrastructure providers like Livepeer.
...
<Steps>
  <Step title="Access the full-screen stream">
    ...
    <Frame caption="Once your stream is live, you'll see a small frame icon in the bottom right corner of the video output window.">
