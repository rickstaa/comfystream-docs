...
wget "https://civitai.com/api/download/models/128713?token=YOUR_API_KEY" --content-disposition
```
...
```bash
cd /workspace/ComfyUI/models/checkpoints
wget "https://civitai.com/api/download/models/VERSIONID?token=YOUR_TOKEN_HERE" --content-disposition
```
