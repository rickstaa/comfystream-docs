...
<Info>Since ComfyUI is started in the `comfyui` environment, you can usually install nodes directly via **ComfyUI-Manager**. If you do this, you only need to [install the nodes for ComfyStream](#install-nodes-in-comfystream).</Info>
