...
#### Source Setup
1. In the "Source" dropdown menu, select "Webcam" as your input source
2. The interface will display two viewing windows:
...
- Provide Feedback for feature requests or issues
- Explore other pipelines through the "Explore Pipelines" section